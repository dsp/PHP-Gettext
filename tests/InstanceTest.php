...
class InstanceTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $g = Gettext\Gettext::getInstance('./', 'gettext', 'de');
    ...
    {
        $g = Gettext\Gettext::getInstance('./', 'gettext', 'notexistent');
        $this->assertEquals('Foobar', $g->gettext('Foobar'));
    }

    public function testGetInstance()
    {
        $this->assertFalse(Gettext\Gettext::getInstance('./', 'gettext', '1') ===
            Gettext\Gettext::getInstance('./', 'gettext', '2'));
        $this->assertTrue(Gettext\Gettext::getInstance('./', 'gettext', '1') ===
            Gettext\Gettext::getInstance('./', 'gettext', '1'));
    }
